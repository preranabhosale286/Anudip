...
public class StudentQues3
{
	public static void main(String[] args)
	{
		...
		stud.add(new Student(1,"Prerana",22,75));
		stud.add(new Student(2,"Rutika",22,79));
		stud.add(new Student(3,"Athrav",24,80));
		stud.add(new Student(4,"Pooja",21,86));
		stud.add(new Student(5,"Amar",22,58));
		stud.add(new Student(6,"Priya",22,60));
